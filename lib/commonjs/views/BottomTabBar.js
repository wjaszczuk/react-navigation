...
class TabBarBottom extends React.Component {
  constructor(...args) {
    ...
    _defineProperty(this, "keyboardWillShowSubscibtion", void 0);

    _defineProperty(this, "keyboardWillHideSubscription", void 0);

    _defineProperty(this, "keyboardDidShowSubscibtion", void 0);

    _defineProperty(this, "keyboardDidHideSubscription", void 0);
  ...
  componentDidMount() {
    if (_reactNative.Platform.OS === 'ios') {
      this.keyboardWillShowSubscibtion = _reactNative.Keyboard.addListener('keyboardWillShow', this._handleKeyboardShow);
      this.keyboardWillHideSubscription = _reactNative.Keyboard.addListener('keyboardWillHide', this._handleKeyboardHide);
    } else {
      this.keyboardDidShowSubscibtion = _reactNative.Keyboard.addListener('keyboardDidShow', this._handleKeyboardShow);
  ...
  componentWillUnmount() {
    if (_reactNative.Platform.OS === 'ios') {
      this.keyboardWillShowSubscibtion.remove();
      this.keyboardWillHideSubscription.remove();
    } else {
      this.keyboardDidShowSubscibtion.remove();
