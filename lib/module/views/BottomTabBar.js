...
class TabBarBottom extends React.Component {
  ...
  componentDidMount() {
    if (Platform.OS === 'ios') {
      this.keyboardWillShowSubscibtion = Keyboard.addListener('keyboardWillShow', this._handleKeyboardShow);
      this.keyboardWillHideSubscription = Keyboard.addListener('keyboardWillHide', this._handleKeyboardHide);
    } else {
      this.keyboardDidShowSubscibtion = Keyboard.addListener('keyboardDidShow', this._handleKeyboardShow);
