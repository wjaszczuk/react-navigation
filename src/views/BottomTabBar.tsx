...
class TabBarBottom extends React.Component<BottomTabBarProps, State> {
  ...
  private keyboardWillShowSubscibtion: EmitterSubscription;
  private keyboardWillHideSubscription: EmitterSubscription;
  private keyboardDidShowSubscibtion: EmitterSubscription;
  private keyboardDidHideSubscription: EmitterSubscription;
  ...
  componentDidMount() {
    if (Platform.OS === 'ios') {
      this.keyboardWillShowSubscibtion = Keyboard.addListener(
        'keyboardWillShow',
      ...
      this.keyboardDidShowSubscibtion = Keyboard.addListener(
        'keyboardDidShow',
        this._handleKeyboardShow
      );
